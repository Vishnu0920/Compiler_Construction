...
typedef struct ASTNode {
    ...
    union {
        ...
        char* str_val;
        struct { struct ASTNode* left; struct ASTNode* right; } op;
        struct { char* name; int var_type; } var_decl;
        struct { char* name; } var_ref;
        struct { struct ASTNode* condition; struct ASTNode* true_branch; struct ASTNode* false_branch; } if_stmt;
        struct { struct ASTNode* condition; struct ASTNode* body; } while_stmt;
        struct { struct ASTNode* var; struct ASTNode* init; struct ASTNode* limit; int op_type; struct ASTNode* step; struct ASTNode* body; } for_stmt;
        struct { char* var_name; struct ASTNode* value; } assign;
        struct { struct ASTNode* arg; } print;
        struct { char* format; struct ASTNode* args; } scan;
        struct { char* format; struct ASTNode* args; } formatString;
        struct { struct ASTNode* vars; struct ASTNode* stmts; } program;
    } data;
} ASTNode;
...
typedef struct {
    ...
    int value;
    int base;         // <-- Add this for int variables
    int initialized;
} Symbol;
